...
const Header=()=>{
    ...
    return(
        <div className={`w-full h-20 bg-white drop-shadow-lg shadow-zinc-300 ring-zinc-400 ring-1 dark:bg-black dark:drop-shadow-black flex justify-between items-center px-2 lg:px-6 transition-colors duration-300 **:transition-colors **:duration-300 ${theme} relative`} style={{zIndex: 1000}}>
